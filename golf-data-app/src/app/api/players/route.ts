...
export async function GET() {
  try {
    ...
    const formattedPlayers = playersList.map((p: any, idx: number) => {
      ...
      const stats16 = p.stats16 || { sgOTT: 0, sgAPP: 0, sgARG: 0, sgPUTT: 0, sgT2G: 0, sgTotal: 0, bob: 0, ba: 0 };
      const stats32 = p.stats32 || { sgOTT: 0, sgAPP: 0, sgARG: 0, sgPUTT: 0, sgT2G: 0, sgTotal: 0, bob: 0, ba: 0 };
      const stats64 = p.stats64 || { sgOTT: 0, sgAPP: 0, sgARG: 0, sgPUTT: 0, sgT2G: 0, sgTotal: 0, bob: 0, ba: 0 };
